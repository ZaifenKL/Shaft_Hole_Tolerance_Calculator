...
<Project Type="Project" LVVersion="23008000">
	...
	<Item Name="My Computer" Type="My Computer">
		...
		<Item Name="Prompt-Window" Type="Folder">
			<Item Name="Help_Prompt-W.vi" Type="VI" URL="../Prompt-W/Help_Prompt-W.vi"/>
			<Item Name="Simple_OK-Warning_Prompt-W.vi" Type="VI" URL="../Prompt-W/Simple_OK-Warning_Prompt-W.vi"/>
		</Item>
		<Item Name="SubVI" Type="Folder">
			<Item Name="A11rowmm.vi" Type="VI" URL="../Subvi/A11rowmm.vi"/>
			<Item Name="A13rowin.vi" Type="VI" URL="../Subvi/A13rowin.vi"/>
			<Item Name="A14rowin.vi" Type="VI" URL="../Subvi/A14rowin.vi"/>
			<Item Name="Array_2_Xml.vi" Type="VI" URL="../Subvi/Array_2_Xml.vi"/>
			...
			<Item Name="Set_Max_Base_Values.vi" Type="VI" URL="../Subvi/Set_Max_Base_Values.vi"/>
		</Item>
		<Item Name="System" Type="Folder">
			<Item Name="Basic_Concepts.txt" Type="Document" URL="../System/Basic_Concepts.txt"/>
			<Item Name="References.txt" Type="Document" URL="../System/References.txt"/>
		</Item>
		<Item Name="Tolerances" Type="Folder">
			<Item Name="ITinch.txt" Type="Document" URL="../Tolerances/ITinch.txt"/>
			<Item Name="ITmm.txt" Type="Document" URL="../Tolerances/ITmm.txt"/>
			<Item Name="ShaftIn.txt" Type="Document" URL="../Tolerances/ShaftIn.txt"/>
			<Item Name="Shaftmm.txt" Type="Document" URL="../Tolerances/Shaftmm.txt"/>
			<Item Name="Type_Fit.xml" Type="Document" URL="../Tolerances/Type_Fit.xml"/>
		</Item>
		<Item Name="Typedef" Type="Folder">
			<Item Name="Data_Cluster.ctl" Type="VI" URL="../TypeDef/Data_Cluster.ctl"/>
			<Item Name="Help_Menu.ctl" Type="VI" URL="../TypeDef/Help_Menu.ctl"/>
			<Item Name="Hole_Data.ctl" Type="VI" URL="../TypeDef/Hole_Data.ctl"/>
